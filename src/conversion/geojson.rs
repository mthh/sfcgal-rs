...
use crate::{ToSFCGAL, CoordSeq, Result, SFCGeometry, ToCoordinates};
use crate::conversion::coords::{Point2d, Point3d, CoordType, ToSFCGALGeom, FromSFCGALGeom};
use failure::Error;
...
// impl ToGeoJSON for SFCGeometry {
//     type Err = Error;
//     fn to_geojson(&self, type: ) -> Result<GeometryValue> {
//         let cs: CoordSeq<Self::Item> = self.to_coordinates()?;
//         match cs {
